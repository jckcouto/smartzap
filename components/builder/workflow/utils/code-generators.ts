...
import { AUTO_GENERATED_TEMPLATES } from "@/lib/builder/codegen-registry";
import conditionTemplate from "@/lib/builder/codegen-templates/condition";
import databaseQueryTemplate from "@/lib/builder/codegen-templates/database-query";
import httpRequestTemplate from "@/lib/builder/codegen-templates/http-request";
