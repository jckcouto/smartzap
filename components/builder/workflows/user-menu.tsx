...
} from "@/components/builder/auth/dialog";
import { ApiKeysOverlay } from "@/components/builder/overlays/api-keys-overlay";
import { IntegrationsOverlay } from "@/components/builder/overlays/integrations-overlay";
import { useOverlay } from "@/components/builder/overlays/overlay-provider";
import { SettingsOverlay } from "@/components/builder/overlays/settings-overlay";
import { Avatar, AvatarFallback, AvatarImage } from "@/components/builder/ui/avatar";
...
import { signOut, useSession } from "@/lib/builder/auth-client";
