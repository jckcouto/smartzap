          ...
          <div className="space-y-4">
            <div>
              ...
              <textarea
                ...
                className="w-full h-32 px-4 py-3 bg-zinc-800 rounded-lg border border-zinc-700 focus:border-primary-500 focus:outline-none resize-none text-sm"
              />
            ...
            <div className="flex gap-4">
              <div className="flex-1">
                ...
                <select
                  ...
                  className="w-full px-4 py-2.5 bg-zinc-800 rounded-lg border border-zinc-700 focus:border-primary-500 focus:outline-none"
                >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-primary-500 hover:bg-primary-600 disabled:bg-zinc-700 disabled:text-zinc-400 rounded-lg transition-colors font-medium"
            >
              {isGenerating ? (
                <>
        ...
        {hasTemplates && (
          <div className="flex items-center justify-between p-4 border-t border-zinc-700 bg-zinc-900/50">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-primary-500 hover:bg-primary-600 disabled:bg-zinc-700 disabled:text-zinc-400 rounded-lg transition-colors font-medium"
            >
              {isExporting ? (
                <>
