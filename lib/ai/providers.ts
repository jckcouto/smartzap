...
export const AI_PROVIDERS: AIProviderConfig[] = [
    ...
    },
    {
        ...
        icon: '🤖',
        models: [
            { id: 'gpt-5.1-codex-mini', name: 'GPT-5.1 Codex Mini', description: 'Código otimizado, compacto' },
            { id: 'gpt-5.1-codex', name: 'GPT-5.1 Codex', description: 'Especializado em código' },
            { id: 'gpt-5.1-chat-latest', name: 'GPT-5.1 Chat Latest', description: 'Chat mais recente' },
            { id: 'gpt-5.1', name: 'GPT-5.1', description: 'Modelo padrão GPT-5.1' },
            { id: 'gpt-5-pro', name: 'GPT-5 Pro', description: 'Máxima capacidade' },
